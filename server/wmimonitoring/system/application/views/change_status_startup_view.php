    		<div id="twocolumn">
                <div id="left">
                    <iframe src="<?=site_url("change_log/grid_log_startup")?>" frameborder="0" height="220" width="375" id="gridshow" name="gridshow"></iframe>
    ...
    dojo.require("dojo.fx");
        ...
        function showdetail(id){
            if(dojo.byId('detail').innerHTML!="")
                hide_detail();
            var xhrargs={
                url: "<?=site_url("change_log/detail_startup")?>/"+id,
                handleAs:"json",
                preventCache:false,
                load: function(data){
...
//                    ]).play();
        ...
        function updatedata(){
            hide_detail();
            var xhrargs={
                url: "<?=site_url("change_log/save_startup_status")?>/",
                handleAs:"text",
