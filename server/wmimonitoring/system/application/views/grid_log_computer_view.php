...
<script type="text/javascript">
    ...
    function refreshgrid(){
        store2.close();
        store2._jsonFileUrl="<?=site_url("computer_setting/json_log_computer")?>";
        store2.fetch();
        grid2._refresh();
        //alert("test");
    }
...
<span dojoType="dojo.data.ItemFileReadStore"
      jsId="store2" url="<?=site_url("computer_setting/json_log_computer")?>" clearOnClose="true" urlPreventCache="false" id="store2">
</span>
