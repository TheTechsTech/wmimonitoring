<html>
<head>
<title>Grid Computer Profile</title>
<style type="text/css">
...
<script type="text/javascript">
    ...
    function refreshgrid(){
        store2.close();
        store2._jsonFileUrl="<?=site_url("computer_profile/jsondata")?>";
        store2.fetch();
        grid2._refresh();
        //alert("test");
...
<span dojoType="dojo.data.ItemFileReadStore"
      jsId="store2" url="<?=site_url("computer_profile/jsondata")?>" clearOnClose="true" urlPreventCache="false" id="store2">
</span>
<table dojoType="dojox.grid.DataGrid"
    ...
    <thead>
        <tr>
            ...
            <th width="100px" field="admin">Admin</th>
            <th width="100px" field="timing_audit_hw" styles='text-align: right;'>Audit HW(Days)</th>
            <th width="100px" field="timing_audit_sw" styles='text-align: right;'>Audit SW(Days)</th>
            <th width="50px" field="is_monitor_registry">Monitor Registry</th>
            <th width="50px" field="is_monitor_process">Monitor Process</th>
