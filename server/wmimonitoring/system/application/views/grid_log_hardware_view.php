...
<script type="text/javascript">
    ...
    function refreshgrid(){
        store2.close();
        store2._jsonFileUrl="<?=site_url("change_log/json_log_hardware")?>";
        store2.fetch();
        grid2._refresh();
        //alert("test");
    }
...
<span dojoType="dojo.data.ItemFileReadStore"
      jsId="store2" url="<?=site_url("change_log/json_log_hardware")?>" clearOnClose="true" urlPreventCache="false" id="store2">
</span>
...
<table dojoType="dojox.grid.DataGrid"
    ...
    <thead>
        <tr>
            ...
            <th width="150px" field="item">Item</th>
