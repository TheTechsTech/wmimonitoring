    		<div id="twocolumn">
                <div id="left">
                    <iframe src="<?=site_url("change_log/grid_log_software")?>" frameborder="0" height="220" width="375" id="gridshow" name="gridshow"></iframe>
    ...
    <script type="text/javascript">
        ...
        function showdetail(id){
            if(dojo.byId('detail').innerHTML!="")
                hide_detail();
            var xhrargs={
                url: "<?=site_url("change_log/detail_software")?>/"+id,
                handleAs:"json",
                preventCache:false,
                load: function(data){
...
//                    ]).play();
        ...
        function updatedata(){
            hide_detail();
            var xhrargs={
                url: "<?=site_url("change_log/save_software_status")?>/",
                handleAs:"text",
